...
export type GetCharactersByPageQuery = { __typename?: 'Query', characters?: { __typename?: 'Characters', info?: { __typename?: 'Info', pages?: number | null } | null, results?: Array<{ __typename?: 'Character', name?: string | null, species?: string | null, status?: string | null, gender?: string | null, image?: string | null } | null> | null } | null };
...
/**
 * __useGetCharactersByPageQuery__
 *
 * To run a query within a React component, call `useGetCharactersByPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCharactersByPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetCharactersByPageQuery(baseOptions?: Apollo.QueryHookOptions<GetCharactersByPageQuery, GetCharactersByPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCharactersByPageQuery, GetCharactersByPageQueryVariables>(GetCharactersByPageDocument, options);
      }
export function useGetCharactersByPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCharactersByPageQuery, GetCharactersByPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCharactersByPageQuery, GetCharactersByPageQueryVariables>(GetCharactersByPageDocument, options);
        }
